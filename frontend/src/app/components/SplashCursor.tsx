...
// Default warna disesuaikan dengan palet StudyHub: biru muda (#0EA5E9), bukan rainbow/merah
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    // --- Event listener khusus untuk landing page (terbatas pada area canvas, bukan window global) ---
    ...
    // Cleanup saat komponen unmount (penting karena SplashCursor dipasang/dilepas saat pindah halaman)
    return () => {
      window.removeEventListener('mousemove', handleFirstMouseMove);
      window.removeEventListener('touchstart', handleFirstTouchStart);
